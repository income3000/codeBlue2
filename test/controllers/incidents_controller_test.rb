...
class IncidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incident" do
    assert_difference("Incident.count") do
      post incidents_url, params: { incident: { comment: @incident.comment, story: @incident.story, title: @incident.title } }
    end
  ...
  test "should update incident" do
    patch incident_url(@incident), params: { incident: { comment: @incident.comment, story: @incident.story, title: @incident.title } }
